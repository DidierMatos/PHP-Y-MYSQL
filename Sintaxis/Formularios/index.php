...
<body>
	...
	<form action="recibe.php" method=""> <!-- ACTION permite mandar esa info a dicho archivo, METHOD permite elegir si ver o no ver la url en el navegador de la info que se esta enviando -->
